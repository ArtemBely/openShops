    ...
    const returnFields = () => {
        return (React.createElement("div", null, arr.map((key) => (React.createElement("div", null,
            React.createElement("p", { className: 'post_name' },
                "\u0417\u0430\u0433\u043E\u043B\u043E\u0432\u043E\u043A ",
                key + 1),
            React.createElement("input", { type: 'text', className: 'main_characteristics_input', name: `technicalTitle${key + 1}` }),
            React.createElement("p", { className: 'post_name special_descr' },
                "\u041E\u043F\u0438\u0441\u0430\u043D\u0438\u0435 ",
                key + 1),
            React.createElement("input", { type: 'text', className: 'main_characteristics_input', name: `technicalDescription${key + 1}` }))))));
    };
