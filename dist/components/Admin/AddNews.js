...
export const AddNews = (props) => {
    ...
    return (React.createElement("div", { style: { display: defineNews == 'vacancies' || defineNews == 'news' ? 'block' : 'none' } },
        ...
        React.createElement("input", { type: 'text', name: 'title', form: defineNews == 'vacancies' ? 'vacancyForm' : 'newsForm', value: props.data ? name.title : undefined, onChange: (e) => { e.target.name = e.target.value; }, required: true, className: 'news_post_input' }),
