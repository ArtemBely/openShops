...
export const Technical = (props:any) => {
       ...
       <div>
         {props.val[0].map((item:any, key:number) => (
           <div>
               ...
               <input type='text' name='technicalTitle' form='projectsForm' value={props.val ? name.mainName[key] : undefined} onChange={(e:any) => {
               ...
               <input type='text' name='technicalDescription' form='projectsForm' value={props.val ? name.mainDescription[key] : undefined} onChange={(e:any) => {
