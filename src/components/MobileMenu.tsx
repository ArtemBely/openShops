    ...
    <div className='wrap_mobileMenu' style={{
        ...
        <div className='mobile_menu'>
            <div className='wrap_mobile_Elements'>
              <NavLink to='/' className='mobile_logo_mobile'><img src={logo} id='logo'/></NavLink>
              <div className='burgerMobile' onClick={closeMobile}>
                  <p className='each_burger_span leftRotate' style={{ backgroundColor: 'white' }}></p>
                  <p className='each_burger_span dispNone' style={{ backgroundColor: 'white' }}></p>
                  <p className='each_burger_span rightRotate' style={{ backgroundColor: 'white' }}></p>
              </div>
            </div>
