  ...
  return (
    <div className="screen2">
      <div className="wrap_fone4">
        ...
        <img src={fone5} className="screen_imgs1 hideMobile" />
        <img src={fone6} className="screen_imgs1 hideMobile" />
      ...
      <a href="#request_field" className="request_field_link">
        <div className="discuss_button2 screenFourDiscuss">Заполнить бриф</div>
      </a>
    </div>
  );
};
